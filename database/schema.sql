...
CREATE TABLE `projects` (
  ...
  `default_execution_mode` enum('autonomous','semi-autonomous','supervised') DEFAULT 'autonomous',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tickets` (
  ...
  `execution_mode` enum('autonomous','semi-autonomous','supervised') DEFAULT NULL,
  `pending_permission` json DEFAULT NULL,
  `approved_permissions` json DEFAULT NULL,
